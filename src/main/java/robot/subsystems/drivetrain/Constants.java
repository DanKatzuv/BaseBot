...
public class Constants {
    ...
    public static final double DISTANCE_PER_PULSE = 0.003451;
    public static final double NINTEEN_DISTANCE = (0.2032 * Math.PI) / 231;//diameter of the wheel is 0.2032 meters (8 inches), the encoder sends 226 pulses every 360 degree turn
